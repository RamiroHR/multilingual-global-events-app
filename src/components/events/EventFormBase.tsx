...
const EventFormContent = ({
  ...
  // Hook to store & restore form data in localStorage
  useFormPersistence(formKey, values, setFieldValue);

  // Tailwind base shared styles:
...
export const EventFormBase = ({
  ...
  onSuccess,
  onCancel,
  formKey = "event-form", // default formKey
}: EventFormBaseProps & { formKey?: string }) => {
